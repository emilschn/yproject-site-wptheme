				...
				<section>
					...
					<div>
						...
						<div style="margin: 16px 0px;">
							...
							<a class="social_network" href="<?php echo home_url(); ?>/rss.xml" target="_blank"><img src="<?php echo $stylesheet_directory_uri; ?>/images/reseaux/icon-rss.jpg" alt="<?php _e( 'footer.RSS_FEED', 'yproject' ); ?>"/></a>
						</div>
