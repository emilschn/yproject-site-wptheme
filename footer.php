	...
	if ( isset( $_GET[ 'campaign_id' ] ) ) {
		...
		echo 'selected="selected"';
				...
				<div class="logo-list clear">
					...
					<div>
						<a href="http://www.financeparticipative.org/" target="_blank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/footer/membre-fpf-2024.png" alt="logo membre financement participatif France" width="140"></a>
					</div>
