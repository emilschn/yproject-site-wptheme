...
$wdg_functions_loaded_required_once = array(
	...
	'functions/languages-helpers.php',
...
function get_investments_data() {
	...
	$input_show_failed_payments= filter_input(INPUT_POST, 'show_failed_payments');
	$investments_list = WDGCampaignInvestments::get_list( $campaign_id, ( $input_is_short_version == '0' ), ( $input_show_failed_payments == '1' ) );
