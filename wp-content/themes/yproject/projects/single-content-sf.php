...
$bopp= BoppLib::get_project($bopp_campaign_id);
	...
	<div id="projects-left-desc" class="left">
		<div id="projects-summary-bopp">
		<?php if($can_modify){ ?>
			<div class="edit_description">
				<a class="edit-button" href="#" data-action="edit_description">Editer</a>
				<span class="cancel_save">
				    <a class="cancel-button" href="#" data-action="cancel_description">Annuler</a> 
				    <a class="save-button" href="#" data-campaign="<?= $campaign_id ?>" data-action="save_description">Enregistrer</a> 
				</span>
			</div>
			<?php } ?>
			<div class="controls">
		...
		<div id="tabs">
		    <ul>
		        <li class="video_tab">
		            <a href="#video_project"></a>
		        </li>
		        <li class="photo_tab">
		            <a href="#image_project"></a>
		        </li>
		    </ul>
		    <div id="video_project">
		       	<div class="video-zone">
					...
					<div class="edit_video">
						<a class="edit-button" href="#" data-action="edit_video">Editer</a>
						<span class="cancel_save">
						    <a class="cancel-button" href="#" data-action="cancel_video">Annuler</a> 
						    <a class="save-button" href="#" data-campaign="<?= $campaign_id ?>" data-action="save_video">Enregistrer</a> 
						</span>
					</div>

					<label class="control-label" for="projectVideo"><strong>► VIDEO YOUTUBE </strong></label>
					<div class="controls">
						<input type="text" value="<?php if ($bopp->project_video_url) { echo $bopp->project_video_url;}?>" class="edit-input edit-video-field" data-placeholder="" id="projectVideo" name="projectVideo">
					</div>
					<div id="video-project">
					<?php 
					if ($bopp->project_video_url != "") {
						$video_element = wp_oembed_get($bopp->project_video_url, array('width' => 550));
						echo $video_element; 
					} else { 
		    ...
		    <div id="image_project">
				...
				?>
		         <div class="update_field atcf-update-campaign-image-home">
					<label class="update_field_label" for="image_home"></label>
					<form id="image_home_upload" method="post" action="#" enctype="multipart/form-data" >
					  <span class="btn_file"><input type="file" name="image_home" id="image_home"></span>
		...
		<div class="projects-desc-item">
			...
			<div class="excerpt">
					...
					<div class="edit_projects">
						<a class="edit-button" href="#" data-action="edit_project">Editer</a>
						<span class="cancel_save">
						    <a class="cancel-button" href="#" data-action="cancel_project">Annuler</a>
						    <a class="save-button" href="#" data-campaign="<?= $campaign_id ?>" data-action="save_project">Enregistrer</a> 
						</span>
					</div>
					<?php } ?>
					...
					<?php if($can_modify){ ?> <span class="tooltip-left tooltips_projects project_return_on_investment_tooltips" data-tooltip="Renseignez le pourcentage estimant le retour sur investissement prévu par le prévisionnel"></span> <?php } ?>		
					...
					<?php if($can_modify){ ?> <span class="tooltip-left tooltips_projects project_investor_benefit_tooltips" data-tooltip="Renseignez l'avantage que vous pouvez proposer à vos investisseurs (une réduction sur un achat, l'invitation à une visite privée du lieu...)"></span> <?php } ?>		
				...
				<div class="more">
					<?php if($can_modify){ ?> <span class="tooltip-left tooltips_projects project_summary_tooltips" data-tooltip="Résumez le projet concerné par le financement en dix lignes."></span> <?php } ?>	
		...
		<div class="projects-desc-item">
			...
			<div class="excerpt">
				...
				<div class="edit_societal">
					<a class="edit-button" href="#" data-action="edit_societal">Editer</a>
					<span class="cancel_save">
					    <a class="cancel-button" href="#" data-action="cancel_societal">Annuler</a> 
					    <a class="save-button" href="#" data-campaign="<?= $campaign_id ?>" data-action="save_societal">Enregistrer</a> 
					</span>
				</div>
				<?php } ?>
				...
				<div class="control-group">
					<?php if($can_modify){ ?> <span class="tooltip-left tooltips_societal project_economy_excerpt_tooltips" data-tooltip="En mots clés (résumé de vos impacts économiques)"></span> <?php } ?>	
				...
				<!-- Text input-->
				<?php if($can_modify){ ?> <span class="tooltip-left tooltips_societal project_social_excerpt_tooltips" data-tooltip="En mots clés (résumé de vos impacts sociaux)"></span> <?php } ?>	
				<div class="control-group">
				...
				<!-- Text input-->
				<?php if($can_modify){ ?> <span class="tooltip-left tooltips_societal project_environment_excerpt_tooltips" data-tooltip="En mots clés (résumé de vos impacts environnementaux)"></span> <?php } ?>	
				<div class="control-group">
			...
			<div class="more">
				<!-- div -->
				<?php if($can_modify){ ?> <span class="tooltip-left tooltips_societal project_mission_tooltips" data-tooltip="A quel problème social ou environnemental votre projet s'attaque-t-il ?
Quelle est la mission de votre projet sa raison d'être, la vision qui le porte, ses valeurs et principes d'action ?"></span> <?php } ?>	
				...
				<!-- div -->
				<?php if($can_modify){ ?> <span class="tooltip-left tooltips_societal project_economy_tooltips" data-tooltip="Impacts économiques
Qu'apporte votre projet en termes d'emploi et d'activité économique (choix des partenaires, relations commerciales, locaux, etc.) ?"></span> <?php } ?>	
				...
				<!-- div -->
				<?php if($can_modify){ ?> <span class="tooltip-left tooltips_societal project_social_tooltips" data-tooltip="Impacts sociaux
Quelles personnes bénéficient directement et indirectement de votre activité ? Comment ?"></span> <?php } ?>	
				...
				<!-- div -->
				<?php if($can_modify){ ?> <span class="tooltip-left tooltips_societal project_environment_tooltips" data-tooltip="Impacts environnementaux / Quels impacts positifs votre activité a-t-elle sur l'environnement ?
Quelle est l'empreinte environnementale de votre activité et comment la limitez-vous ?"></span> <?php } ?>	
				...
				<!-- div -->
				<?php if($can_modify){ ?> <span class="tooltip-left tooltips_societal project_measure_performance_tooltips" data-tooltip="Gouvernance
Qu'allez vous mettre en place pour assurer le suivi de vos impacts et impliquer vos parties prenantes dans votre activité ?"></span> <?php } ?>	
				...
				<!-- div -->
				<?php if($can_modify){ ?> <span class="tooltip-left tooltips_societal project_good_point_tooltips" data-tooltip="Un mot à ajouter ? Vous êtes drôle ? Votre projet a un aspect ludique ?  un point bonus non encore signalé ? C'est le moment pour en parler !
"></span> <?php } ?>	
				<div class="control-group">
				...
				<div id="project-content-economic" class="projects-desc-content">
					<div class="excerpt">
						...
						<div class="edit_economy">
							<a class="edit-button" href="#" data-action="edit_economy">Editer</a>
							<span class="cancel_save">
							    <a class="cancel-button" href="#" data-action="cancel_economy">Annuler</a> 
							    <a class="save-button" href="#" data-campaign="<?= $campaign_id ?>" data-action="save_economy">Enregistrer</a> 
							</span>
						</div>
						<?php } ?>

						<h2 >Quelle est l'opportunité économique du projet ?</h2>
						<?php if($can_modify){ ?> <span class="tooltip-left tooltips_economy project_context_excerpt_tooltips" data-tooltip="En mots clés (résumé du contexte général ci-dessous)"></span> <?php } ?>	
						<div class="control-group">
						...
						<!-- Text input-->
						<?php if($can_modify){ ?> <span class="tooltip-left tooltips_economy project_market_excerpt_tooltips" data-tooltip="En mots clés (résumé du contexte de marché ci-dessous)"></span> <?php } ?>	
						<div class="control-group">
					...
					<div class="more">
						...
						<!-- div -->
						<?php if($can_modify){ ?> <span class="tooltip-left tooltips_economy project_market_tooltips" data-tooltip="Marché : qui sont vos concurrents ? Comment vous différenciez-vous d'eux  ?"></span> <?php } ?>	
						<div class="control-group">
			...
			<div class="projects-desc-item">
				...
				<div class="excerpt">
					...
					<div class="edit_model">
						<a class="edit-button" href="#" data-action="edit_model">Editer</a>
						<span class="cancel_save">
						    <a class="cancel-button" href="#" data-action="cancel_model">Annuler</a> 
						    <a class="save-button" href="#" data-campaign="<?= $campaign_id ?>" data-action="save_model">Enregistrer</a> 
						</span>
					</div>
					<?php } ?>
					...
					<h2 >Quel est le modèle économique du projet ?</h2>
						<!-- Text input-->
						<?php if($can_modify){ ?> <span class="tooltip-left tooltips_model project_worth_offer_tooltips" data-tooltip="En mots clés (résumé de votre proposition de valeur ci-dessous)"></span> <?php } ?>	
						<div class="control-group">
						...
						<!-- Text input-->
						<?php if($can_modify){ ?> <span class="tooltip-left tooltips_model project_client_collaborator_tooltips" data-tooltip="En mots clés (résumé de vos clients et partenaires ci-dessous)"></span> <?php } ?>	
						<div class="control-group">
						...
						<!-- Text input-->
						<?php if($can_modify){ ?> <span class="tooltip-left tooltips_model project_business_core_tooltips" data-tooltip="En mots clés (résumé de vos activités ci-dessous)"></span> <?php } ?>	
						<div class="control-group">
						...
						<!-- Text input-->
						<?php if($can_modify){ ?> <span class="tooltip-left tooltips_model project_income_tooltips" data-tooltip="En mots clés (résumé de votre structure de revenus ci-dessous)"></span> <?php } ?>	
						<div class="control-group">
							...
							<!-- Text input-->
							<?php if($can_modify){ ?> <span class="tooltip-left tooltips_model project_cost_tooltips" data-tooltip="En mots clés (résumé de votre structure de coûts ci-dessous)"></span> <?php } ?>	
							<div class="control-group">
							...
							<div class="more">
								...
								<div id="canvas">
									<?php if($can_modify){ ?> <span class="tooltip-left tooltips_model project_collaborators_canvas_tooltips" data-tooltip="Qui sont vos fournisseurs et partenaires clés ? Quelles sont leurs activités ? Quelles ressources acquérez-vous auprès d'eux ?"></span> <?php } ?>	
									<div class="controls-wp">
									...
									<?php if($can_modify){ ?> <span class="tooltip-left tooltips_model project_activities_canvas_tooltips" data-tooltip="Quelles activités sont nécessaires pour réaliser et distribuer votre offre (production, réflexion/conseil, animation, plateforme, etc.) ?
Quel est votre coeur de métier ?"></span> <?php } ?>	
									...
									<?php if($can_modify){ ?> <span class="tooltip-left tooltips_model project_ressources_canvas_tooltips" data-tooltip="De quelles ressources avez-vous besoin / disposez-vous pour réaliser et vendre votre offre (physiques, intellectuelles, humaines, financières) ?
De quelle manière pourriez-vous utiliser ces ressources différemment ?"></span> <?php } ?>	
									...
									<?php if($can_modify){ ?> <span class="tooltip-left tooltips_model project_worth_offer_canvas_tooltips" data-tooltip="A quel problèmes/besoins répondez vous chez vos clients (nouveauté, performance, réduction des coûts, accessibilité, marque...) ?
Quels produits / services proposez-vous ?"></span> <?php } ?>	
									...
									<?php if($can_modify){ ?> <span class="tooltip-left tooltips_model project_customers_relations_canvas_tooltips" data-tooltip="Quelle relation entretenez-vous avec vos clients (assistance personnalisé, self service, communauté d'entraide, etc.) ?"></span> <?php } ?>	
									<div class="controls-wp">
									...
									<?php if($can_modify){ ?> <span class="tooltip-left tooltips_model project_chain_distributions_canvas_tooltips" data-tooltip="Comment vous faites-vous connaître de vos clients ?
...
Comment fournissez-vous un service après vente ?"></span> <?php } ?>	
									...
									<?php if($can_modify){ ?> <span class="tooltip-left tooltips_model project_clients_canvas_tooltips" data-tooltip="Qui sont vos clients (par catégorie et type de profil) ? Incluez des chiffres de votre étude de marché."></span> <?php } ?>	
									<div class="controls-wp">
									...
									<?php if($can_modify){ ?> <span class="tooltip-left tooltips_model project_cost_structure_canvas_tooltips" data-tooltip="Quels sont les coûts de votre business model (activités, ressources, distribution, etc.) ?
...
Comment pouvez-vous les réduire (économies d'échelle, de gamme) ?"></span> <?php } ?>	
									...
									<?php if($can_modify){ ?> <span class="tooltip-left tooltips_model project_source_of_income_canvas_tooltips" data-tooltip="Quelles sont vos sources de revenus possibles ?
...
Comment payent-ils votre offre (ventes uniques, location, abonnement, forfait, à l'usage, etc.) ?"></span> <?php } ?>	
									...
									<!-- div -->
									<?php if($can_modify){ ?> <span class="tooltip-left tooltips_model project_financial_board_tooltips" data-tooltip="Pourquoi investir dans votre projet ? Cela donne-t-il droit à une réduction IR / ISF (investissement en capital seulement) ?
...
Intégrez sous forme d'image des tableaux financiers : liste détaillée des dépenses permises par la collecte et compte de résultat prévisionnel. Si besoin, explicitez en quelques mots ces tableaux financiers. Ajouter quelques informations sur votre prévisionnel global, votre capital, vos apports personnels..."></span> <?php } ?>	
									...
									<!-- div -->
									<?php if($can_modify){ ?> <span class="tooltip-left tooltips_model project_perspectives_tooltips" data-tooltip="Quelles perspectives de développement offre votre projet ?"></span> <?php } ?>	
									<div class="control-group">
		...
		<div class="projects-desc-item">
			...
			<div id="project-content-porteur" class="projects-desc-content">
				...
				<div class="edit_members">
					<a class="edit-button" href="#" data-action="edit_members">Editer</a>
					<span class="cancel_save">
					    <a class="cancel-button" href="#" data-action="cancel_members">Annuler</a> 
					    <a class="save-button" href="#" data-campaign="<?= $campaign_id ?>" data-action="save_members">Enregistrer</a> 
					</span>
				</div>
				<?php } ?>
				...
				<div class="control-group">
					<?php if($can_modify){ ?> <span class="tooltip-left tooltips_name project_other_information_tooltips" data-tooltip="Expliquez les origines de l'idée et du projet.
