...
ob_end_clean();
echo do_shortcode('[yproject_lightbox_cornered id="pending-investment" title="'.__( 'invest.lightbox.investment.TITLE', 'yproject' ).'" autoopen="1" catchclick="1" save-close="1"]' . $lightbox_content . '[/yproject_lightbox_cornered]');
