...
<?php foreach ( $wdg_current_field[ 'options' ] as $option_label ): $rate++; ?>
	...
	<input type="checkbox" id="<?php echo $wdg_current_field[ 'name' ] .'-'. $rate; ?>" name="<?php echo $wdg_current_field[ 'name' ] .'-'. $rate; ?>" value="<?php echo $rate; ?>" class="rate <?php echo $wdg_current_field[ 'name' ]; ?>" data-rate="<?php echo $wdg_current_field[ 'name' ]; ?>" data-description="<?php echo $option_label; ?>" <?php echo $str_checked; ?> />
<?php endforeach; ?><br />
