...
function printPageProject() {
    global $post;
    ?>
    <div id="post_top_bg">
	<div id="post_top_title" class="center" style="background: TODO.jpg">
	...
	<div id="post_bottom_content" class="center">
		...
		<div class="project_progress_bar">
		    ...
		    <span class="project_full_progressprint"><?php echo $percent; ?>%</span>
		</div>
	    ...
	    <div>
		<div class="project_preview_item_desc">
		    <?php 
			/*
		...
		<div class="controls">
		    <button id="flow" name="flow" class="btn btn-primary">Suivre ce projet</button>
