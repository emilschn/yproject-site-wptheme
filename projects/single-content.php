		...
		<div id="project-owner">
			...
			if ( !empty( $current_organization ) ) {
				...
				$owner_str = '<div id="orga-edit" data-link-edit="'
                                        ...
                                        .'">'
                                        . '<a href="#project-organization" class="wdg-button-lightbox-open" data-lightbox="project-organization">' . $wdg_organization->get_name()
                                        . '</a>'
                                        . '</div><br />';
				$owner_str .= '<div id="wdg-lightbox-project-organization" class="wdg-lightbox hidden">
