...
<div class="wdg-lightbox-ref">
	...
	<div class="align-center">
		<img src="<?php echo $stylesheet_directory_uri; ?>/images/common/picto-diagramme-loupe.png" width="100" />
	</div>
	<br /><br />
	
	<div class="align-justify">
		<strong><?php _e( "Attention l'investissement dans des soci&eacute;t&eacute;s non cot&eacute;es comporte des risques sp&eacute;cifiques :", 'yproject' ); ?></strong><br />
		<br />
		...
		<br />
		<strong><?php _e( "Avez‐vous conscience que vous pouvez &eacute;ventuellement perdre la totalit&eacute; de votre investissement ?", 'yproject' ); ?></strong><br />
		<br />
