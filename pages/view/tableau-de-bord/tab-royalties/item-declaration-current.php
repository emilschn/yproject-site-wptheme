...
<div id="declaration-item-<?php echo $declaration->id; ?>" class="declaration-item">
	...
	<?php if ( !$is_future ): ?>
		<?php if ( $declaration->get_status() != WDGROIDeclaration::$status_transfer && $declaration->get_status() != WDGROIDeclaration::$status_waiting_transfer && $declaration->is_first_declaration_to_pay() ): ?>			
			<div class="single-line">
