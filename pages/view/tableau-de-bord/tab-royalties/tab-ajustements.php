...
<div id="stat-subtab-ajustements" class="stat-subtab hidden">
	...
	<?php if ( $page_controler->can_access_admin() ): ?>
		...
		<form action="<?php echo $page_controler->get_form_adjustment_action(); ?>" method="post" id="form-add-adjustment" class="db-form v3 full center bg-white admin-theme hidden">
