...
<div id="adjustment-item-more-<?php echo $adjustment_obj->id; ?>" class="adjustment-item-more hidden">
	...
	<?php if ( $page_controler->can_access_admin() ): ?>
		<form action="<?php echo $page_controler->get_form_adjustment_action(); ?>" method="post" id="form-edit-adjustment-<?php echo $adjustment_obj->id; ?>" class="db-form v3 full center bg-white admin-theme-block adjustment-edit-form hidden">
