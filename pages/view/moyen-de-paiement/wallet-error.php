...
<div class="investment-form">
    ...
    <a href="<?php echo $page_controler->get_restart_link(); ?>" class="investment-button">
        ...
        <span class="button-loading loading align-center hidden">
            <img class="alignverticalmiddle marginright" src="<?php echo $stylesheet_directory_uri; ?>/images/loading-grey.gif" width="30" alt="chargement" /><?php _e( 'invest.mean-payment.error.RESTARTING', 'yproject' ); ?>
        </span>
    </a>.
</div>