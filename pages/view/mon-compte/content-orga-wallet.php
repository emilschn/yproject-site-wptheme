...
<div class="db-form v3 align-left" id="item-body-wallet">
	...
	<?php else: ?>
		...
		<p class="align-justify">
			<strong><?php _e( 'account.wallet.TRANSFER_ID_CODE', 'yproject' ); ?></strong> <span id="clipboard-user-lw-code-<?php echo $WDGOrganization->get_lemonway_id(); ?>">wedogood-<?php echo $WDGOrganization->get_lemonway_id(); ?></span><br>
			<div class="align-center">
				<button type="button" class="button blue copy-clipboard" data-clipboard="clipboard-user-lw-code-<?php echo $WDGOrganization->get_lemonway_id(); ?>"><?php _e( 'account.wallet.COPY_CODE', 'yproject' ); ?></button>
